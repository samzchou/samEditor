...
(function () {
    ...
    var collectRangeSections = function (dom, rng) {
      ...
      return collect(dom, rng.commonAncestorContainer, startNode, endNode, {
        ...
        cef: function (node) {
          var sections = bind(descendants(SugarElement.fromDom(node), '.info-block'), function (e) { //*[contenteditable]
    ...
    var fromRng = function (dom, rng) {
      return rng.collapsed ? [] : collectRangeSections(dom, rng); //rng.collapsed ? [] : 
    };
    ...
    var open = function (editor, currentSearchState) {
      var dialogApi = value();
      var isReadonly = editor.mode.isReadOnly();
      ...
      // console.log('editor.mode', editor.mode.isReadOnly())
      dialogApi.set(editor.windowManager.open(spec, { inline: 'toolbar' }));
    };

    var register$1 = function (editor, currentSearchState) {
      //console.log('doc_config',editor.settings.doc_config)
      editor.addCommand('search', function () {
