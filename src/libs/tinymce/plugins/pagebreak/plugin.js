...
(function () {
    ...
    var pageBreakClass = 'mce-pagebreak mceNonEditable';
    var getPlaceholderHtml = function (shouldSplitBlock) {
      ...
      var html = '<hr class="' + pageBreakClass + '" data-mce-resize="false" data-mce-placeholder />';
    ...
    var setup = function (editor) {
      ...
      editor.on('BeforeSetContent', function (e) {
        e.content = e.content ? e.content.replace(pageBreakSeparatorRegExp, getPlaceholderHtml(shouldSplitBlock$1())) : '';
      });
