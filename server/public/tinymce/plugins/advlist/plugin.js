...
(function () {
    ...
    var getNumberStyles = function (editor) {
      //var styles = editor.getParam('advlist_number_styles', 'default,lower-alpha,upper-alpha,lower-greek,lower-roman,upper-roman');
      var styles = editor.getParam('advlist_number_styles', 'default,lower-alpha,upper-alpha,lower-roman');
