...
!function(y) {
    ...
    u = function(e, t) {
        e.dom.bind(t, "drop dragstart dragend dragover dragenter dragleave dragdrop draggesture",
        function(e) {
            e.preventDefault(),
    ...
    j = P("function"),
    U = P("number"),
    B = void 0 === (T = Array.prototype.indexOf) ?
    function(e, t) {
        return z(e, t)
    }: function(e, t) {
        return T.call(e, t)
    ...
    G = function(e, t) {
        for (var n = 0,
        r = e.length; n < r; n++) if (t(e[n], n, e)) return _.some(n);
        return _.none()
    },
    z = function(e, t) {
        for (var n = 0,
    ...
    be = window.Promise ? window.Promise: function() {
        ...
        t = e.immediateFn || "function" == typeof window.setImmediate && window.setImmediate ||
        function(e) {
            y.setTimeout(e, 1)
        };
        function n(e, t) {
        ...
        function u() {
            for (var e = 0,
            t = this._deferreds.length; e < t; e++) i.call(this, this._deferreds[e]);
    ...
    Ee = function(e, t) {
        return function(e, t) {
            for (var n, r, o = void 0 !== t ? t: xe, i = 0; i < e.length; ++i) n = o,
            r = e[i],
    ...
    function Oe(e) {
        ...
        for (var r = n[1], o = t[1], i = Ce.atob(o), a = i.length, u = Math.ceil(a / 1024), c = new Array(u), s = 0; s < u; ++s) {
            for (var l = 1024 * s,
            f = Math.min(l + 1024, a), d = new Array(f - l), m = l, p = 0; m < f; ++p, ++m) d[p] = i[m].charCodeAt(0);
            c[s] = Le(d)
        }
        return _.some(Ie(c, {
            type: r
    ...
    Tt = function(n) {
        return (e = n, "" === e ? _.none() : _.some(e.substr(0, 1))).bind(function(t) {
    ...
    Ot = function(e) {
        ...
        return {
            browser: p,
            os: g,
            deviceType: (n = p, r = e, o = (t = g).isiOS() && !0 === /ipad/i.test(r), i = t.isiOS() && !o, a = t.isAndroid() && 3 === t.version.major, u = t.isAndroid() && 4 === t.version.major, c = o || a || u && !0 === /mobile/i.test(r), s = t.isiOS() || t.isAndroid(), l = s && !c, f = n.isSafari() && t.isiOS() && !1 === /safari/i.test(r), {
                isiPad: v(o),
                isiPhone: v(i),
                isTablet: v(c),
                isPhone: v(l),
    ...
    jt = y.Node.TEXT_NODE,
    Ut = (y.Node.PROCESSING_INSTRUCTION_NODE, y.Node.ENTITY_REFERENCE_NODE, y.Node.ENTITY_NODE, y.Node.NOTATION_NODE,
    function(e) {
    ...
    qt = Yt(jt),
    $t = function(e, t, n) {
        if (! (k(n) || F(n) || U(n))) throw y.console.error("Invalid call to Attr.set. Key ", t, ":: Value ", n, ":: Element ", e),
    ...
    cn = {
        fromHtml: function(e, t) {
            ...
            if (n.innerHTML = e, !n.hasChildNodes() || 1 < n.childNodes.length) throw y.console.error("HTML does not have a single root node", e),
    ...
    dn = {
        ...
        extend: function(n) {
            ...
            return tinymce.each(Array.prototype.slice.call(arguments, 1),
            function(e) {
    ...
    Tn = function(o) {
        ...
        t = function() {
            return i = {},
            a = 0,
            dn.each(o.attributes,
            function(e) {
                var t, n = e.nodeName,
                r = e.value; (!1 !== (t = e).specified || "name" === t.nodeName && "" !== t.value) && null != r && (i[n] = r, a++)
            }),
    ...
    In = function(i, e, t) {
        ...
        switch (i.nodeType) {
        case 1:
            e ? n = yn: (n = hn, a = Tn(i), u = {},
            c = i, s = function(e, t) {
                u[e] = t
            },
            null != (d = t || c.getAttribute("style")) && d.split || (d = c.style.cssText), dn.each(d.split(";"),
            function(e) {
                var t = e.indexOf(":");
                0 < t && ((l = dn.trim(e.substring(0, t))).toUpperCase() === l && (l = l.toLowerCase()), l = l.replace(/([A-Z])/g,
                function(e, t) {
    ...
    Dn = function(e, o) {
        ...
        return {
            ...
            next: function() {
                var e, t, n = a,
                r = c;
                return ! c && a.firstChild ? (u.push(a), a = a.firstChild) : c || 1 !== a.nodeType ? a.nextSibling ? (a = a.nextSibling, c = !1) : (a = u.pop(), c = !0) : c = !0,
    ...
    Rn = An(function(e, t) {
        var n, r = function() {
            Mn || (e.emit(Cn.createStartElement("P", {},
            {},
            e.document)), Mn = !0)
        };
        switch (t.type()) {
    ...
    Wn = An(function(e, t) {
        e.seenList || (e.inferring ? "LI" === t.tag() && (t.type() === Cn.START_ELEMENT_TYPE ? e.inferring++:(e.inferring--, e.inferring || (e.needsClosing = !0))) : ("OL" === t.tag() || "UL" === t.tag() ? e.seenList = !0 : "LI" === t.tag() && (e.inferring = 1, e.needsClosing || e.emit(Cn.createStartElement("UL", {},
        {},
        e.document))), !e.needsClosing || e.inferring || t.isWhitespace() || (e.needsClosing = !1, e.emit(Cn.createEndElement("UL", e.document))))),
        e.emit(t)
    }),
    qn = _n(function(e, t) {
    ...
    er = function(e, t) {
        var n, r, o = 1;
        for (n = t + 1; n < e; n++) if ((r = Zn[n]) && "SPAN" === r.tag()) if (r.type() === Cn.START_ELEMENT_TYPE) o++;
    ...
    Er = {
        guessListType: function(e, t, n) {
            var r, o, i, a = null;
            return e && (r = e.text, o = e.symbolFont),
            r = dn.trim(r),
            ...
            function(e) {
                if (e.regex.test(r)) {
                    if (t && Tr(e.type, t, !0)) return (a = e.type).start = parseInt(r, 10),
                    !1;
                    a || (a = e.type),
    ...
    wr = function(e) {
        var t = e.indexOf(".");
        if (0 <= t && void 0 === dn.trim(e.substring(t + 1))) return (void 0)[2],
        !1
    },
    Ir = (Ue = function(e, t) {
        var n, r = /([^{]+){([^}]+)}/g;
    ...
    Lr = function() {
        ...
        return {
            guessIndentLevel: function(e, t, n, r) {
                var o, i;
                return r && /^([0-9]+\.)+[0-9]+\.?$/.test(r.text) ? r.text.replace(/([0-9]+|\.$)/g, "").length + 1 : (o = u || parseInt(Ir(n, t.getAttribute("class"))), i = function(e, t) {
                    var n, r = 0;
                    for (n = e.parentNode; null != n && n !== t.parentNode;) r += n.offsetLeft,
                    n = n.offsetParent;
                    return r
    ...
    function Dr(a, u) {
        ...
        m = function(e, t, n) {
            ...
            i && !Er.eqListType(i, t) && (f(), n && (a.emit(Cn.createStartElement("P", {},
            {},
            u)), a.emit(Cn.createText("\xa0", u)), a.emit(Cn.createEndElement("P", u))), l(t, !0)),
            a.emit(Cn.createStartElement("LI", {},
            r, u)),
            e && "P" !== e.tag() ? (c.push(e.tag()), e.filterStyles(function() {
                return null
            }), a.emit(e)) : c.push("P")
        };
        return {
            ...
            openItem: function(e, t, n, r) {
                if (n) {
                    ...
                    f();
                    var o, i;
                    if (i = e, "UL" === (o = n).tag && Nr[i - 1] === o.type && (o = {
                        tag: "UL"
                    }), n = o, s === e) d(),
                    m(t, n, r);
                    else for (1 < e && 0 < c.length && "P" !== c[c.length - 1] && (a.emit(Cn.createEndElement(c[c.length - 1], u)), c[c.length - 1] = "P"); s < e;) l(n, s === e - 1),
                    m(s === e ? t: void 0, n)
                }
            },
    ...
    kr = function(e, t, n) {
        n.type() === Cn.END_ELEMENT_TYPE && t.originalToken.tag() === n.tag() && (t.nextFilter = Ar, t.styleLevelAdjust = -1),
        e.emit(n)
    },
    Mr = function(e, t, n) {
        if (n.type() === Cn.START_ELEMENT_TYPE && "Ignore" === n.getStyle("mso-list") && (t.nextFilter = Rr), n.type() === Cn.START_ELEMENT_TYPE && "SPAN" === n.tag()) t.spanCount.push(n),
        ...
        else if (n.type() === Cn.TEXT_TYPE) if (t.commentMode) t.nextFilter = Rr,
        t.nextFilter(e, t, n);
        else {
    ...
    Ur = function(o, i, a) {
        var e = function(e) {
            ...
            if (i.nextFilter = Br, i.commentMode && (i.itemLevel = i.indentGuesser.guessIndentLevel(a, i.originalToken, i.styles.styles, i.bulletInfo)), i.listType = Er.guessListType(i.bulletInfo, (t = i.emitter.getCurrentListType(), n = i.emitter.getCurrentLevel(), r = i.itemLevel, n === r ? t: null), i.originalToken), i.listType) {
                ...
                e && o.emit(a)
            } else dn.log("Unknown list type: " + i.bulletInfo.text + " Symbol font? " + i.bulletInfo.symbolFont),
            o.rollback()
        };
    ...
    function Jr(u, e, t, r, c) {
        ...
        u.on("dragstart dragend",
        function(e) {
            s = "dragstart" === e.type
        }),
        u.on("dragover dragend dragleave",
        function(e) {
            s || e.preventDefault()
        });
        var f = function(e, t) {
        ...
        function(e) {
            if (!s) {
                ...
                var n = (a = (i = e).target.files || i.dataTransfer.files, $(a,
                function(e) {
                    return l.test(e.type)
                }));
                if (0 < n.length) return m(n),
    ...
    ci = function(e, t) {
        ...
        return e.match({
            ...
            text: o,
            html: o,
            xml: (n = "Invalid XML document", r = o,
            function() {
    ...
    Ti = function(e, t) {
        return function(e, t) {
            for (var r = t,
            n = r.parser[r.strictMode ? "strict": "loose"].exec(e), o = {},
            i = 14; i--;) o[r.key[i]] = n[i] || "";
            return o[r.q.name] = {},
            o[r.key[12]].replace(r.q.parser,
            function(e, t, n) {
                t && (o[r.q.name][t] = n)
            }),
            o
    ...
    Li = function(e, t) {
        ...
        o = Ti(t, n),
        i = {};
        return "" !== o.protocol ? (i.protocol = o.protocol, i.authority = o.authority, i.path = Ii(o.path), i.query = o.query) : ("" !== o.authority ? (i.authority = o.authority, i.path = Ii(o.path), i.query = o.query) : ("" === o.path ? (i.path = r.path, "" !== o.query ? i.query = o.query: i.query = r.query) : (Et(o.path, "/") ? i.path = Ii(o.path) : (i.path = Si(r.path, o.path, e.authority), i.path = Ii(i.path)), i.query = o.query), i.authority = r.authority), i.protocol = r.protocol),
        i.anchor = o.anchor,
        i
    },
    Ci = function(e, t) {
    ...
    function Ni(d) {
        ...
        o = function(e, t, l) {
            ...
            s = fi.file(yi.buildData("image", e, f)); (n = d.url, r = s, o = gi.text(), i = c, u = Ho.post(), si(n, u, _.some(r), o, i, a)).map(function(e) {
                e.fold(function(e) {
                ...
                function(t) {
                    ...
                    try {
                        var i = Ko.parse(t);
                        if (!k(i.location)) return e = "JSON response did not contain a string location",
                        r = 500,
                        o = t,
    ...
    Qi = function(e, n, a, r, u, t, c) {
        ...
        function(e) {
            ...
            function(t) {
                var e, n, r, o; (e = a, n = i, r = u, o = t, q(n,
                function(e) {
                    Vt(e, "src", o.location),
                    Kt(e, go.blobId())
                }), Zi(e, r)).fold(s,
    ...
    function ia(c) {
        var s = function(e, t) {
            return v(4 === (o = oa.getTinymceVersion()).major() && o.minor() < 6 ? e: e + "." + (n = t.toLowerCase(), (r = {
                "image/jpeg": "jpg",
                "image/jpg": "jpg",
                "image/gif": "gif",
                "image/png": "png"
    ...
    var Ta = function(t, r, e, n) {
        ...
        if (!l.get("_mcePaste")) {
            ...
            '\ufeff<br _mce_bogus="1">'), u = f !== t.getDoc().body ? l.getPos(t.selection.getStart(), f).y: f.scrollTop, l.setStyles(o, {
                position: "absolute",
                left: -1e4,
                top: u,
                width: 1,
                height: 1,
                overflow: "hidden"
            }), tinymce.isIE) return (a = l.doc.body.createTextRange()).moveToElementText(o),
            a.execCommand("Paste"),
            l.remove(o),
            ...
            if (l.bind(t.getDoc(), "mousedown", g), l.bind(t.getDoc(), "keydown", g), tinymce.isGecko && (a = t.selection.getRng(!0)).startContainer === a.endContainer && 3 === a.startContainer.nodeType) {
            ...
            window.setTimeout(function() {
                ...
                function(e) {
                    ...
                    dn.each(l.select("div.mcePaste", e),
                    function(e) {
                        l.remove(e, 1)
                    }),
                    dn.each(l.select("span.Apple-style-span", e),
                    function(e) {
                        l.remove(e, 1)
                    }),
                    dn.each(l.select("br[_mce_bogus]", e),
                    function(e) {
                        l.remove(e)
                    }),
                    n += e.innerHTML
    ...
    Ea = {
        ...
        getOnKeyDownFunction: function(t, n, r) {
            return function(e) { (tinymce.isOpera || 0 < navigator.userAgent.indexOf("Firefox/2")) && ((tinymce.isMac ? e.metaKey: e.ctrlKey) && 86 === e.keyCode || e.shiftKey && 45 === e.keyCode) && Ta(t, n, r, e)
            }
        }
    },
    ...
    Na = {
        ...
        cata: Ca,
        carry: function(e, r) {
            return Ca(e, _.none, _.none, _.none,
            function(e, t, n) {
                return Ca(r, _.none,
                function(e, t) {
    ...
    Ya = function(e, t, n) {
        if (!k(n)) throw y.console.error("Invalid call to CSS.set. Property ", t, ":: Value ", n, ":: Element ", e),
    ...
    Ga = function(e) {
        return Ht(e) ? (t = "v:shape", n = e.dom().nodeValue, r = cn.fromTag("div"), o = n.indexOf("]>"), r.dom().innerHTML = n.substr(o + "]>".length), Wi(r,
        function(e) {
            return Ut(e) === t
        })) : _.none();
        var t, n, r, o
    ...
    iu = function(e, t, n) {
        var r, o, i = W(e.dom().attributes,
        function(e) {
            return e.name
        });
        ae(t) !== i.length && (r = e, o = t, q(i,
        function(e) {
            Kt(r, e)
        }), ne(o,
        function(e, t) {
    ...
    Du = function(e, t, n) {
        var r, o = n;
        for (r = t.length - 1; 0 <= r; r--) o = t[r](o, {},
        e);
        return o
    },
    Ou = function(e, t, n) {
    ...
    $u = function(e, t) {
        if (void 0 === e || void 0 === t) throw y.console.trace(),
        "brick";
        e.nextFilter.set(t)
    },
    Vu = function(e, t, n) {
    ...
    Ju = function(d) {
        return function(e, t, n) {
            ...
            var c, s, l, f = (c = n, s = u, Ku((l = t).listType.get(), c, l.emitter, s).each(l.listType.set), zu(s.level(), l.originalToken.get(), l.listType.get()));
    ...
    Tc = function(e, t, n) {
        ...
        }: {}), fc.result(i.state(), o.result().concat(i.result()))) : fc.result(e, []),
        c = [N(Lu.createStartElement, "LI", {},
        a)],
        s = dc(u.state(), t && t.tag()),
        l = s.value().map(function(e) {
    ...
    Nc = {
        openItem: function(e, t, n, r) {
            ...
            h = v.state().level() === t ? (f = v.state(), d = r, m = n, p = 0 < f.level() ? wc(f) : fc.result(f, []), g = Tc(p.state(), m, d), Ic([p, g])) : (o = v.state(), i = r, u = n, c = 1 < (a = t) ? mc(o) : fc.value(o, _.none()), s = c.value().map(function(e) {
                return [N(Lu.createEndElement, e)]
            }).getOr([]), c.state().level(), l = Lc(c.state(), i, a, u), fc.result(l.state(), s.concat(l.result())));
            return Ic([v, h])
        },
        closeAllLists: Cc
    },
    ...
    jc = (oc = Ac(rc = Fc), ic = Ac(null), ac = Ac(null), {
        reset: function(e) {
            ...
            ic.set(null),
            ac.set(null);
            var n, r, i, a, t = (r = (n = e).document, i = fc.state(0, void 0, [], []), a = function(e) {
                q(e.result(),
                function(e) {
                    var t = e(r);
                    n.emit(t)
    ...
    es = function(e) {
        return (r = e, Xc.extractLevel(r).bind(function(n) {
    ...
    os = {
        ...
        hasContent: function(e) {
            return ! rs(e) || (n = (t = e).dom().attributes, r = null != n && 0 < n.length, ("span" !== Ut(t) || r) && ns(e,
            function(e) {
                var t = !rs(e),
    ...
    qs = {
        ...
        removeFragmentComments: function(a) {
            ...
            t.each(function(i) {
                n.each(function(e) {
                    for (var t, n = i,
                    r = [], o = (t = bs(i, 0, e, 0), cn.fromDom(t.commonAncestorContainer)); void 0 !== o && !Io(o, a);) Y(u, Ut(o)) ? n = o: r.push(o),
                    o = Co(o).getOr(void 0);
                    q(r, ja),
                    q(Ao(n), Fa)
                }),
    ...
    Vs = function(i, a) {
        return Uu(function(e, t) {
            var r, o, n = (r = t, o = a, i(cn.fromDom(r.getNode())).fold(function() {
                return [r]
            },
            function(e) {
    ...
    Xs = function(e, t, n) {
        var r, o, i, a, u, c, s, l, f, d, m, p, g, v = (r = e, i = (o = n).browser.isFirefox() || o.browser.isEdge(), a = i ? Ka.local: Ka.vshape, u = !i, c = $s(o) ? qs.none: Ru([Vs(a, u)]), {
            annotate: [r ? c: qs.none],
            local: [i ? qs.none: qs.removeLocalImages]
        });
        return Z([(p = e, g = n, $s(g) || !p ? [] : [ts.preprocess]), v.annotate, [qs.inlineTagFixes],
        function(e, t, n) {
            if (!e) return [qs.none];
            var r = [qs.unwrapWordTags],
            o = $s(n) ? [] : qs.parseLists;
            return r.concat(o).concat([qs.removeWordAttributes])
        } (e, 0, n), [qs.removeGoogleDocsId], [qs.nestedListFixes], [qs.removeExcess], [qs.removeMetaTags], v.local, (m = t, m ? [qs.mergeStyles, qs.mergeClasses] : [qs.cleanStyles, qs.cleanClasses]), [qs.distillAnchorsFromLocalLinks, qs.removeLocalLinks, qs.removeVacantLinks, qs.replaceClipboardChangedUrls], [qs.removeEmptyStyle], [qs.removeEmptyClass], [qs.pruneInlineTags], [qs.cleanupBrowserTags], (f = e, d = t, !f && d ? [qs.cleanupBrowserCruft] : []), [qs.unwrapConvertedSpace], [qs.addPlaceholders], (s = e, l = n, $s(l) && s ? [qs.unwrapSingleParagraphsInlists] : []), [qs.cleanupFlags], [qs.removeStyleTags]])
    },
    ...
    Sl = {
        links: function(e) {
            ...
            q(t,
            function(e) {
                var n, t = e.exact(); (t.indexOf("@") < 0 || Il(t)) && (n = e.elements(), _.from(n[0]).filter(wl).map(function(e) {
                    var t = cn.fromTag("a");
                    return ua(e, t),
                    ma(t, n),
                    Vt(t, "href", qc(t)),
    ...
    Ll = function(e) {
        var t = _o(e);
        q([Sl.links, Sl.position, Sl.list],
        function(e) {
            e(t)
        })
    },
    ...
    Rf = function(e) {
        ...
        function(e) {
            ...
            return Pf(i) ? (r = e, o = i, Me(o).map(function(e) {
                return Sf.assetImage(an.single(e), r)
            })).toArray() : kf(i) ? (n = e, t = i, Re(t).map(function(e) {
    ...
    function Ff(f) {
        return function(e, l) {
            return _a.sync(function(u) {
                ...
                e = function(e, t, n) {
                    var r, o, i, a; ! 1 === f.allowLocalImages ? s(e) : 0 === t.length ? (o = Rf(r = e), i = Ke(o,
                    function(e) {
                        return e.asset()
                    }), a = W(o,
                    function(e) {
    ...
    Jf = function(e) {
        ...
        n = function(e) {
            var t, r, o, i, n = (r = (t = e).bower, o = t.regex, i = t.isEquation, Zf(r).map(function(e) {
                var n = t.idRef + e;
        ...
        r = 0; r < e.length;) r = Gf(e, r).fold(t, n);
        return a
    },
    Qf = function(e) {
    ...
    td = {
        convert: function(e, t, n, o) {
            ...
            function(t, e) {
                ...
                "unsupported" === n ? (u = !0, Vt(t, "alt", o("errors.imageimport.unsupported")), []) : X(i,
                function(e) {
            ...
            1 : [function(e, t, n) {
                ...
                a = function(c) {
                    ...
                    return e = function(e, t) {
                        var n, r, o, i, a, u;
                        if (e.test(s)) for (r = 0, o = (n = s.match(e)).length; r < o; r += 1) l[t] += 1,
                        i = n[r],
                        a = s.indexOf(i),
                        u = i.length,
                        f.push({
                    ...
                    (t = function(e) {
                        var t, n, r, o;
                        if (e.test(s)) for (n = 0, r = (t = s.match(e)).length; n < r; n += 1) o = t[n],
                    ...
                    function() {
                        var e, t, n, r, o = /{[^]*/gm;
                        if (o.test(s)) for (t = 0, n = (e = s.match(o)).length; t < n; t += 1) r = e[t],
    ...
    Bd = function(l, e) {
        var f = function(n) {
            ...
            ne(function(e) {
                var t = {},
                n = e.dom();
                if (Ba(n)) for (var r = 0; r < n.style.length; r++) {
                    var o = n.style.item(r);
                    t[o] = n.style[o]
                }
                return t
            } (n),
            function(e, t) { ! t.startsWith("border") || "border-image" !== t && "none" !== e.trim() && "initial" !== e.trim() || Xa(n, t)
            })
        },
    ...
    Hd = function(e, t, n) {
        var r = n.mergeInline(); (r ? Fd.inlineStyles: Ud)(e, t, jd),
        Bd(t, r)
    },
    Wd = function(n) {
    ...
    rm = function(e) {
        ...
        return _a.sync(function(e) {
            var t, n, r, o, i = 0 < a.text().length ? (t = a.text(), n = tm(t), r = nm(n), o = aa(r), Na.paste(o, [])) : Na.cancel();
            _a.call(e, {
                response: i,
                bundle: Sa.nu({})
            })
    ...
    lm = function(u, c) {
        return function(e, t) {
            var a = t.bundle();
            return sd.proxyBin(a).handle("There was no proxy bin setup. Ensure you have run proxyStep first.",
            function(e) {
                var t = sd.merging(a),
                n = sd.isWord(a),
                r = sd.isInternal(a),
            ...
            return {
                start: function(e, t, n, r) {
                    ...
                    i = y.setInterval(function() {
                        n() ? y.clearInterval(i) : o <= 0 ? (u.trigger.timeout(), y.clearInterval(i)) : r() && (y.clearInterval(i), u.trigger.crashed()),
                        o--
                    },
                    e);
                    a.set(_.some(i))
    ...
    function Pm(n, r, o) {
        ...
        t = y.setInterval(function() {
            var t, e = n.dom();
            j(e.PercentLoaded) && 100 === e.PercentLoaded() && (t = e, Q(r,
            function(e) {
                return j(t[e])
            })) && (i(), o())
        },
    ...
    Ap = {
        register: function(e) {
            var t, n;
            e.on("cut", (t = e,
            function(e) { ! 1 === t.selection.isCollapsed() && Np(e, Op(t), Dp(t),
                function() {
                    setTimeout(function() {
            ...
            e.on("copy", (n = e,
            function(e) { ! 1 === n.selection.isCollapsed() && Np(e, Op(n), Dp(n), Lp)
            }))
        }
    },
    _p = {
        ...
        restoreStyleAttrs: function(e) {
            q(W(e.getElementsByTagName("*"), cn.fromDom),
            function(e) {
    ...
    Hp = {
        ...
        linkSelection: function(r, e) {
            return Up(e).bind(function(e) {
                var t, n;
                return ! 1 === r.selection.isCollapsed() && Fp(e.url()) ? Bp(t = r, (n = e).html(),
                function() {
        ...
        insertImage: function(r, e) {
            return Up(e).bind(function(e) {
                return jp(e.url()) ? Bp(t = r, (n = e).html(),
                function() {
    ...
    $p = {
        process: function(e, t, n) {
            ...
            return d = v,
            m = n,
            o = Wp(f = r = e, "PastePreProcess") ? (p = d, g = m, f.fire("PastePreProcess", {
                internal: g,
                content: p
            }).content) : d,
            i = n,
            Wp(r, "PastePostProcess") ? (u = o, c = i, s = (a = r).dom.add(a.getBody(), "div", {
                style: "display:none"
            },
        ...
        registerEvents: function(t) {
            var n = t.settings;
            n.paste_preprocess && t.on("PastePreProcess",
            function(e) {
                n.paste_preprocess.call(t, qp(t), e)
            }),
            n.paste_postprocess && t.on("PastePostProcess",
            function(e) {
    ...
    function Vp(v, h, e, t, y, b) {
        ...
        function(e) {
            ...
            m = (t = d, n = f.createDialog, r = C, i = op((o = l).baseUrl), u = N($m, n), c = bp(void 0 !== o.pasteBinAttrs ? o.pasteBinAttrs: {}), Ef([Dm.onlyText(), Dm.wordimport(i, n, o, u), Dm.googledocs(o, r, t), Dm.nativeHtml(n, o, r, t), Dm.image(o)], Dm.fallback(n, o, r, c, t, u))),
            ...
            v.addCommand("mceInsertClipboardContent",
            function(e, t) {
    ...
    function Gp(u) {
        return c(tinymce, "4.0.28") ? (t.error('The "powerpaste" plugin requires at least 4.0.28 version of TinyMCE.'),
        function() {}) : function(n, e) {
            ...
            function(t, e, n) {
                ...
                t.on("keydown", u(o)),
                t.addCommand("mceInsertClipboardContent",
                function(e, t) {
                    a.showDialog(t.content || t)
                }),
                t.settings.paste_preprocess && t.on("PastePreProcess",
                function(e) {
                    t.settings.paste_preprocess.call(i, i, e)
                })
            } (n, o) : (t = xa(n), Vp(n, o, e, u, t, r), l(n) ? d(n) : Jr(n, 0, 0, t, r)),
            $p.registerEvents(n),
